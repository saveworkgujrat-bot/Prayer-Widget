...
'        <TextView android:layout_width="wrap_content" android:layout_height="wrap_content"\n'
'            android:text="TODAY SCHEDULE" android:textColor="#7AADA0" android:textSize="8sp" android:layout_marginBottom="4dp"/>\n'
...
open('app/src/main/java/com/gujrat/prayerwidget/PrayerUpdateService.kt','w').write(
'package com.gujrat.prayerwidget\n'
...
os.system('./gradlew assembleDebug --no-daemon')
print('Done!')
